...
public class RilyniumElectricArmorItem extends ArmorItem implements GeoItem {
    ...
    public RilyniumElectricArmorItem(RegistryEntry<ArmorMaterial> material, Type type, Settings settings){super(material, type, settings);}

    private static final Map<RegistryEntry<ArmorMaterial>, List<StatusEffectInstance>> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<RegistryEntry<ArmorMaterial>, List<StatusEffectInstance>>())
                    .put(ModArmorMaterials.ELECTRIC_RILYNIUM,
                            List.of(new StatusEffectInstance(StatusEffects.GLOWING, 400, 0, false, false),
                                    new StatusEffectInstance(StatusEffects.HASTE, 400, 1, false, false),
                                    new StatusEffectInstance(StatusEffects.NIGHT_VISION, 40000, 0, false, false)
                            )).build();

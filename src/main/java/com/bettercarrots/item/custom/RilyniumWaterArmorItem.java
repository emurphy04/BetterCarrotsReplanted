...
public class RilyniumWaterArmorItem extends ArmorItem implements GeoItem {
    ...
    public RilyniumWaterArmorItem(RegistryEntry<ArmorMaterial> material, Type type, Settings settings){super(material, type, settings);}

    private static final Map<RegistryEntry<ArmorMaterial>, List<StatusEffectInstance>> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<RegistryEntry<ArmorMaterial>, List<StatusEffectInstance>>())
                    .put(ModArmorMaterials.WATER_RILYNIUM,
                            List.of(new StatusEffectInstance(StatusEffects.CONDUIT_POWER, 400, 1, false, false),
                                    new StatusEffectInstance(StatusEffects.DOLPHINS_GRACE, 400, 1, false, false),

...
public final class ExampleArmorItem extends ArmorItem implements GeoItem {
    ...
    public ExampleArmorItem(RegistryEntry<ArmorMaterial> armorMaterial, ArmorItem.Type type, Settings properties) {
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar controllers) {
        controllers.add(new AnimationController<>(this, 20, state -> {
            ...
            boolean isFullSet = wornArmor.containsAll(ObjectArrayList.of(
                    ModItems.RILYNIUM_BOOTS,
                    ModItems.RILYNIUM_LEGGINGS,
                    ModItems.RILYNIUM_CHESTPLATE,
                    ModItems.RILYNIUM_HELMET));
